...
<Modal id="create-users" modalTitle="Create Front Desk User Account">
  ...
  <div class="p-5">
      ...
      <div class="text-2xl mt-5">Create a new Front Desk User Account</div>
      <form on:submit|preventDefault|stopPropagation="{createUser}" class="border-gray-200 border-dashed">
        ...
        <div class="intro-y box p-5">
          ...
          <div class="text-right mt-5">
            <button type="submit" class="button w-24 bg-theme-1 text-white">Create Front Desk User Account</button>
          </div>
        </div>
        <!-- END: Form Layout -->
      </form>
