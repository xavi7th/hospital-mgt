...
<!-- Example Usage -->
<!-- <Icon name="trash" class="flex-shrink-0 w-3 h-3 text-gray-400 fill-current ml-2"/> -->

{#if name === "apple"}
  <svg class={className} xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100">
    <g fill-rule="nonzero">
      <path
