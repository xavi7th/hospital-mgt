...
<!-- Usage Exmples  -->
<!-- <CheckBoxInput class="main__checkbox" size="{size}rem" bind:checked name="inputName" secondaryColor="rgba(1, 50, 67,0.2)" primaryColor="rgb(77, 5, 232)" /> -->
<!-- <CheckBoxInput class="main__checkbox" size="{size}rem" checked={true} on:change={handleChange3} /> -->
